...
import { updateInventory, type Inventory } from "@/lib/api";
...
export function EditInventoryModal({ open, onClose, inventory }: EditInventoryModalProps) {
  ...
  useEffect(() => {
    if (inventory && open) {
      ...
      setUnit(inventory.unit || "pcs");
      setCostPerUnit(inventory.cost_per_unit != null ? String(inventory.cost_per_unit) : "");
