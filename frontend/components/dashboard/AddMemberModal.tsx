...
export function AddMemberModal({ open, onClose, departmentId }: AddMemberModalProps) {
    ...
    <AnimatePresence>
      {open && (
        <>
          ...
          >
            <div
              className="bg-background border border-foreground/[0.08] rounded-2xl w-full max-w-md p-6 pointer-events-auto shadow-xl max-h-[85vh] overflow-y-auto"
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <div>
                  ...
                  <input
                    type="email"
                    placeholder="e.g. james.reyes@company.com"
                    value={email}
